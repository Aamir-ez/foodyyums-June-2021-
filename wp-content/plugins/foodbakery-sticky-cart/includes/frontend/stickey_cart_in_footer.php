            ...
            <div class="menu-orders-holder user-order footer-cart-bar bgcolor">
                    ...
                    <div class="dev-menu-orders-list" id="count_cart_items"
                        ...
                        <div class="price-area dev-menu-price-con"
                            ...
                            <ul>
                                ...
                                <li><?php esc_html_e('Subtotal', 'foodbakery-sticky-cart') ?> <span
                                            class="price"><?php echo foodbakery_get_currency_sign(); ?><em
                                                class="dev-menu-subtotal"><?php echo restaurant_menu_price_calc($get_added_menus, $foodbakery_restaurant_id, false, false, false, true) ?></em></span>
                                </li>
                                <?php
                                $show_fee_type = '';
                                ...
                                if ($show_fee_type == 'reservation') {
                                    ...
                                    <li class="restaurant-fee-con"><span
                                        ...
                                        <span class="price"><?php echo foodbakery_get_currency_sign(); ?><em
                                                    class="dev-menu-charges"
                                                    data-confee="<?php echo foodbakery_get_currency($foodbakery_reservation_fee, false, '', '', true); ?>"
                                                    data-fee="<?php echo foodbakery_get_currency($foodbakery_reservation_fee, false, '', '', false); ?>"><?php echo foodbakery_get_currency($foodbakery_reservation_fee, false, '', '', true) ?></em></span>
                                    </li>
                                    <?php
                                    ...
                                    <li class="restaurant-fee-con"><span
                                        ...
                                        <span class="price"><?php echo foodbakery_get_currency_sign(); ?><em
                                                    class="dev-menu-charges"
                                                    data-confee="<?php echo foodbakery_get_currency($foodbakery_delivery_fee, false, '', '', true); ?>"
                                                    data-fee="<?php echo foodbakery_get_currency($foodbakery_delivery_fee, false, '', '', false); ?>"><?php echo foodbakery_get_currency($foodbakery_delivery_fee, false, '', '', true) ?></em></span>
                                    </li>
                                    <?php
                                    ...
                                    <li class="restaurant-fee-con"><span
                                        ...
                                        <span class="price"><?php echo foodbakery_get_currency_sign(); ?><em
                                                    class="dev-menu-charges"
                                                    data-confee="<?php echo foodbakery_get_currency($foodbakery_pickup_fee, false, '', '', true) ?>"
                                                    data-fee="<?php echo foodbakery_get_currency($foodbakery_pickup_fee, false, '', '', false) ?>"><?php echo foodbakery_get_currency($foodbakery_pickup_fee, false, '', '', true) ?></em></span>
                                    </li>
                                    <?php
                                }
                                if ($foodbakery_vat_switch == 'on' && $foodbakery_payment_vat > 0) {
                                    ...
                                    <li><?php printf(esc_html__('VAT (%s&#37;)', 'foodbakery-sticky-cart'), $foodbakery_payment_vat) ?>
                                        <span class="price"><?php echo foodbakery_get_currency_sign(); ?><em
                                                    class="dev-menu-vtax"><?php echo restaurant_menu_price_calc($get_added_menus, $foodbakery_restaurant_id, true, false, true, true) ?></em></span>
                                    </li>
                                    <?php
                                }
                                ?>
                            </ul>
                            <p class="total-price"><?php esc_html_e('Total', 'foodbakery-sticky-cart') ?> <span
                                        class="price"><?php echo foodbakery_get_currency_sign(); ?><em
                                            class="dev-menu-grtotal"><?php echo restaurant_menu_price_calc($get_added_menus, $foodbakery_restaurant_id, true, true, false, true) ?></em></span>
                            </p>
                        </div>
                    </div>
                ...
                <ul>
                    ...
                    <li class="cart-bar total-amount">
                        <span><?php echo foodbakery_get_currency_sign(); ?><em
                                    id="cart-total-price"><?php echo $grand_total; ?></em></span>
                    </li>
