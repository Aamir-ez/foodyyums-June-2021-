...
//                    });
        ...
        if (isset($shortcode) && $shortcode <> '') {
            ?>
            <a class="button"
               href="javascript:foodbakery_frame_createpop('composer-<?php echo esc_js($rand) ?>', 'filter')"><i
            ...
            <div id="<?php echo esc_attr($randomno); ?>_del" class="column columnmain parentdeletesection column_100">
                <div class="column-in"><a class="button"
                    ...
                    <p>
                        <a href="javascript:foodbakery_frame_createpop('<?php echo esc_js($column_class . $randomno); ?>','filterdrag')"
                           class="options">
