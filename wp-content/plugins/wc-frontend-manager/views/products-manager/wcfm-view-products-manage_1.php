...
<div class="collapse wcfm-collapse" id="wcfm_products_manage">
    ...
    <div class="wcfm-collapse-content">
        ...
        <div class="wcfm-container wcfm-top-element-container">
            ...
            if ($product_id) {
                ?>
                <span class="product-status product-status-<?php echo $wcfm_products_single->post_status; ?>"><?php
                    if ($wcfm_products_single->post_status == 'publish') {
                    ...
                    <form id="wcfm_products_manage_form" class="wcfm">
                        ...
                        if ($_GET['view'] == "menu-builder") {
                            ...
                            function get_post_by_category($category) {
                                global $product;
                                $n = 1;
                                $args = array('posts_per_page' => -1, 'product_cat' => $category, 'post_type' => 'product');
                                ...
                                <div id="accordion">
                                    ...
                                    echo "<pre>";                                    print_r($posts_query[0]);
                                        ?>
                                        <div class="card">
                                            <div class="card-header" id="product-<?=$n?>">
                                                <h5 class="mb-0">
                                                    <button class="btn btn-link" data-toggle="collapse" data-target="#<?=$posts_query->ID?>" aria-expanded="true" aria-controls="<?=$posts_query->ID?>">
                                                        <?php echo the_title(); ?>
                                                    </button>
                                                </h5>
                                            </div>

                                            <div id="<?=$posts_query->ID?>" class="collapse" aria-labelledby="<?=$posts_query->ID?>" data-parent="#accordion">
                                                <div class="card-body">
                                                    <?php
//                                            echo "<pre>";
//                                            print_r($product);
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <label>Restaurant Menu *</label><div class="restaurants-menu"><select class="chosen-select" id="restaurant_menu_344188362" name="restaurant_menu[344188362]" style="display: none;"><option selected="selected" value="Pizza">Pizza</option><option value="Calzone">Calzone</option><option value="Garlic Bread">Garlic Bread</option><option value="Kebabs">Kebabs</option><option value="Burgers">Burgers</option><option value="Specials">Specials</option><option value="Wraps">Wraps</option><option value="Chicken">Chicken</option><option value="Paninis">Paninis</option><option value="Jacket Potatoes">Jacket Potatoes</option><option value="Starters">Starters</option><option value="Traditional Curries">Traditional Curries</option><option value="Seafood Dishes">Seafood Dishes</option><option value="Biryani Dishes">Biryani Dishes</option><option value="Vegetarian Dishes">Vegetarian Dishes</option><option value="Rice">Rice</option><option value="Sauces">Sauces</option><option value="Bread">Bread</option><option value="Teste">Teste</option></select><div class="chosen-container chosen-container-single" style="width: 0px;" title="" id="restaurant_menu_344188362_chosen"><a class="chosen-single" tabindex="-1"><span>Pizza</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"><li class="active-result result-selected" style="" data-option-array-index="0">Pizza</li><li class="active-result" style="" data-option-array-index="1">Calzone</li><li class="active-result" style="" data-option-array-index="2">Garlic Bread</li><li class="active-result" style="" data-option-array-index="3">Kebabs</li><li class="active-result" style="" data-option-array-index="4">Burgers</li><li class="active-result" style="" data-option-array-index="5">Specials</li><li class="active-result" style="" data-option-array-index="6">Wraps</li><li class="active-result" style="" data-option-array-index="7">Chicken</li><li class="active-result" style="" data-option-array-index="8">Paninis</li><li class="active-result" style="" data-option-array-index="9">Jacket Potatoes</li><li class="active-result" style="" data-option-array-index="10">Starters</li><li class="active-result" style="" data-option-array-index="11">Traditional Curries</li><li class="active-result" style="" data-option-array-index="12">Seafood Dishes</li><li class="active-result" style="" data-option-array-index="13">Biryani Dishes</li><li class="active-result" style="" data-option-array-index="14">Vegetarian Dishes</li><li class="active-result" style="" data-option-array-index="15">Rice</li><li class="active-result" style="" data-option-array-index="16">Sauces</li><li class="active-result" style="" data-option-array-index="17">Bread</li><li class="active-result" style="" data-option-array-index="18">Teste</li></ul></div></div></div><script> jQuery(document).ready(function () {
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <label>Title *</label>
                                                                    <input id="current_restaurant_menu_344188362" type="hidden" value="Pizza"><input name="menu_item_action[344188362]" value="edit" type="hidden"><input class="menu-item-title" id="menu_item_title_344188362" name="menu_item_title[344188362]" value="Marinara Pizza" type="text" placeholder="Menu Item Title">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <label>Price * (£)</label><input class="menu-item-price" id="menu_item_price_344188362" name="menu_item_price[344188362]" type="text" value="70" placeholder="Menu Item Price">
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <label>Food Image</label>
                                                                    <div id="browse-btn-sec-344188362" class="browse-btn-sec" style="display: none !important;">
                                                                        <input type="file" id="image-icon-344188362" data-id="344188362" name="image_icon_344188362" class="browse-menu-icon-file" style="display: none;">
                                                                        <a id="browse-menu-icon-img-344188362" href="javascript:void(0)" class="browse-menu-icon-img btn bgcolor" data-id="344188362">Browse</a>
                                                                    </div>
                                                                    <div id="browse-img-sec-344188362" class="browse-image-sec" style="display: bolck !important;">
                                                                        <div class="icon-img-holder">
                                                                            <a href="javascript:void(0)" data-id="344188362" class="remove-icon"><i class="icon-close2"></i></a>
                                                                            <img id="img-val-base-344188362" src="http://foodbakery.chimpgroup.com/wp-content/uploads/delicious-hot-pizza-150x150.jpg" alt="">
                                                                        </div>
                                                                        <input id="hiden-img-val-344188362" type="hidden" name="menu_item_icon[344188362]" value="20205">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <label>Nutritional Information icons</label><div class="nutri-info-icons"><ul><li><input id="nutri-icon-7641948" type="checkbox" name="menu_item_nutri[344188362][]" value="20215"><label for="nutri-icon-7641948"><a data-toggle="tooltip" title="" data-original-title="Contain Bnana"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item03.png" alt=""></a></label></li><li class="active"><input id="nutri-icon-2238506" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20213"><label for="nutri-icon-2238506"><a data-toggle="tooltip" title="" data-original-title="Contain Egg"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item01.png" alt=""></a></label></li><li class="active"><input id="nutri-icon-2568613" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20214"><label for="nutri-icon-2568613"><a data-toggle="tooltip" title="" data-original-title="Onion"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item02.png" alt=""></a></label></li><li class="active"><input id="nutri-icon-5708230" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20216"><label for="nutri-icon-5708230"><a data-toggle="tooltip" title="" data-original-title="Lettuce"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item04.png" alt=""></a></label></li><li class=""><input id="nutri-icon-6325383" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20217"><label for="nutri-icon-6325383"><a data-toggle="tooltip" title="" data-original-title="Chille"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item05.png" alt=""></a></label></li><li class=""><input id="nutri-icon-8008882" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20201"><label for="nutri-icon-8008882"><a data-toggle="tooltip" title="" data-original-title="Kosher Friendly"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item09.png" alt=""></a></label></li><li><input id="nutri-icon-2939333" type="checkbox" name="menu_item_nutri[344188362][]" value="20200"><label for="nutri-icon-2939333"><a data-toggle="tooltip" title="" data-original-title="Only Vegetable"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item08.png" alt=""></a></label></li><li class=""><input id="nutri-icon-6314884" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20199"><label for="nutri-icon-6314884"><a data-toggle="tooltip" title="" data-original-title="Contain Local Ingredients "><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item07.png" alt=""></a></label></li><li><input id="nutri-icon-857649" type="checkbox" name="menu_item_nutri[344188362][]" value="20198"><label for="nutri-icon-857649"><a data-toggle="tooltip" title="" data-original-title="Contains Fish"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item06.png" alt=""></a></label></li><li><input id="nutri-icon-7614160" type="checkbox" name="menu_item_nutri[344188362][]" value="20197"><label for="nutri-icon-7614160"><a data-toggle="tooltip" title="" data-original-title="Contains Egg"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item13.png" alt=""></a></label></li><li class=""><input id="nutri-icon-1651214" checked="checked" type="checkbox" name="menu_item_nutri[344188362][]" value="20196"><label for="nutri-icon-1651214"><a data-toggle="tooltip" title="" data-original-title="Contain lactose"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item12.png" alt=""></a></label></li><li><input id="nutri-icon-7470170" type="checkbox" name="menu_item_nutri[344188362][]" value="20195"><label for="nutri-icon-7470170"><a data-toggle="tooltip" title="" data-original-title="No Sugar"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item11.png" alt=""></a></label></li><li><input id="nutri-icon-4891803" type="checkbox" name="menu_item_nutri[344188362][]" value="20194"><label for="nutri-icon-4891803"><a data-toggle="tooltip" title="" data-original-title="Low fat"><img src="http://foodbakery.chimpgroup.com/wp-content/uploads/natural-item10.png" alt=""></a></label></li></ul></div>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <label>Description</label><textarea class="menu-item-desc foodbakery_editor" id="menu_item_desc_344188362" name="menu_item_desc[344188362]" placeholder="Menu Item Description test">Cheese, tomatoes, tuna fish, sweetcorn and italian herbs</textarea>
                                                                </div>
                                                            </div><ul id="menu-item-extra-list-344188362" class="menu-item-extra-list"><li class="menu-item-extra-344188362" id="extra_li_0"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="row"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                                <div class="field-holder">
                                                                                    <label>Heading</label>
                                                                                    <input class="menu-item-extra-heading" name="menu_item_extra[344188362][heading][]" value="Extra Topping " type="text" placeholder="Heading">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                                <label>Extra Type</label><select class="chosen-select" id="foodbakery_menu_item_extra344188362" name="menu_item_extra[344188362][type][]" style="display: none;"><option value="single">Single (Radio button)</option><option selected="selected" value="multiple">Multiple (CheckBoxes)</option></select><div class="chosen-container chosen-container-single" style="width: 0px;" title="" id="foodbakery_menu_item_extra344188362_chosen"><a class="chosen-single" tabindex="-1"><span>Multiple (CheckBoxes)</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"></ul></div></div></div>              <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                                <div class="field-holder">
                                                                                    <label>Required</label>
                                                                                    <input class="menu-item-extra-required" id="menu_item_extra_required_344188362" name="menu_item_extra[344188362][required][]" type="text" value="2" placeholder="Required options">
                                                                                </div>
                                                                            </div><a class="cross-icon" href="javascript:void(0);" onclick="remove_more_extra_option_heading('0', '344188362', '0');"><i class="icon-cross-out"></i></a><ul id="menu-item-extra-fields-34418836200" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836200" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][0][title][]" type="text" value="Pepperoni" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][0][price][]" type="text" value="9" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '0', '0');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '0', '0');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836201" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836201" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][0][title][]" type="text" value="Tuna" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][0][price][]" type="text" value="6" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '0', '1');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '0', '1');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836202" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836202" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][0][title][]" type="text" value="Sweet corn" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][0][price][]" type="text" value="0" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '0', '2');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '0', '2');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836203" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836203" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][0][title][]" type="text" value="Asparagus" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][0][price][]" type="text" value="1" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '0', '3');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '0', '3');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836204" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836204" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][0][title][]" type="text" value="Jalapenos" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][0][price][]" type="text" value="2" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '0', '4');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '0', '4');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul></div></div></li><li class="menu-item-extra-344188362" id="extra_li_1"><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><div class="row"><div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                                <div class="field-holder">
                                                                                    <label>Heading</label>
                                                                                    <input class="menu-item-extra-heading" name="menu_item_extra[344188362][heading][]" value="Sausages " type="text" placeholder="Heading">
                                                                                </div>
                                                                            </div>
                                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                                                                <label>Extra Type</label><select class="chosen-select" id="foodbakery_menu_item_extra344188362" name="menu_item_extra[344188362][type][]" style="display: none;"><option selected="selected" value="single">Single (Radio button)</option><option value="multiple">Multiple (CheckBoxes)</option></select><div class="chosen-container chosen-container-single" style="width: 0px;" title="" id="foodbakery_menu_item_extra344188362_chosen"><a class="chosen-single" tabindex="-1"><span>Single (Radio button)</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off"></div><ul class="chosen-results"></ul></div></div></div>              <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                                                                                <div class="field-holder">
                                                                                    <label>Required</label>
                                                                                    <input class="menu-item-extra-required" id="menu_item_extra_required_344188362" name="menu_item_extra[344188362][required][]" type="text" value="1" placeholder="Required options">
                                                                                </div>
                                                                            </div><a class="cross-icon" href="javascript:void(0);" onclick="remove_more_extra_option_heading('1', '344188362', '1');"><i class="icon-cross-out"></i></a><ul id="menu-item-extra-fields-34418836210" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836210" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][1][title][]" type="text" value="Lime Sauce" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][1][price][]" type="text" value="2" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '1', '0');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '1', '0');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836211" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836211" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][1][title][]" type="text" value="Spicy Mayonnaise" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][1][price][]" type="text" value="0" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '1', '1');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '1', '1');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836212" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836212" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][1][title][]" type="text" value="Barbecue Sauce " placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][1][price][]" type="text" value="1" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '1', '2');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '1', '2');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </li>
                                                                            </ul><ul id="menu-item-extra-fields-34418836213" class="menu-item-extra-fields">
                                                                                <li id="menu-item-extra-field-34418836213" class="menu-item-extra-field">
                                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Title</label>
                                                                                                    <input class="menu-item-extra-title" name="menu_item_extra[344188362][1][title][]" type="text" value="Garlic Sauce" placeholder="Title">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="field-holder">
                                                                                                    <label>Price (£)</label>
                                                                                                    <input class="menu-item-extra-price" name="menu_item_extra[344188362][1][price][]" type="text" value="3" placeholder="Price">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                                                                                                <div class="menu-item-extra-options">
                                                                                                    <label>&nbsp;</label>
                                                                                                    <a href="javascript:void(0);" onclick="add_more_extra_option('58937228', '344188362', 'Title', 'Price', '£', '1', '3');">+</a>
                                                                                                    <a href="javascript:void(0);" onclick="remove_more_extra_option('58937228', '344188362', '1', '3');">-</a>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                            ...
                                                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                <div class="field-holder">
                                                                    <a class="add-menu-item-extra add-menu-item-extra-344188362" href="javascript:void(0);" onclick="foodbakery_add_menu_item_extra('58937228', '344188362');">Add Menu Item Extra</a>
                                                                    <a class="add-menu-item add-menu-item-list add-menu-item-list-344188362" href="javascript:void(0);" onclick="foodbakery_add_menu_item_to_list('58937228', '344188362', 'edit');">Save</a>
                                                                </div>
                                                            </div></div>
                                                    </div><!---form--->
                                                </div>
                            ...
                            <link rel="stylesheet" href="<?= site_url();?>/wp-content/plugins/wp-foodbakery/assets/frontend/css/cs-foodbakery-plugin.css">
                            <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
                            <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
                            <style>img.woocommerce-placeholder.wp-post-image {
                            ...
                            <div class="tab-content">
                                <div class="tab-pane container active" id="cate">      
                                    ...
                                    foreach ($product_categories as $cate) {
                                        echo "<li><h4>$cate->name</h4></li>";
                                    }
                                    ?></div>
                                <div class="tab-pane container fade" id="food-menu">
                                    <?php
                                    foreach ($product_categories as $cate) {
                                        echo "<h4>$cate->name</h4> <div class=''>" . get_post_by_category($cate->name) . "</div>";
                                    }
                                    ?>
                                </div>
                            </div>
                        ...
                        <div id="wcfm_products_simple_submit" class="wcfm_form_simple_submit_wrapper">
                            ...
                            <?php } else { ?>
                                <?php if ($product_id && ( $wcfm_products_single->post_status == 'publish' )) { ?>
                                    <input type="submit" name="submit-data" value="<?php
