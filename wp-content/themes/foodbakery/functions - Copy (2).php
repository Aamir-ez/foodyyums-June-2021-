...
//        print_r($_REQUEST);
    ...
    <li class="menu-added" data-val="<?php echo $_REQUEST['order_price']; ?>" 
        ...
        <a href="javascript:void(0)" class="btn-cross remove_menu_item_from_cart">
            <i class="remove_this_item icon-cross3"></i></a>
        <a><?php echo $_REQUEST['order_title']; ?></a>
...
//$sub_total += floatval($sub_total_amount);
    ...
    //    $total = $total+$_REQUEST['order_price'];
    $total = $sub_total + $order_fee_amount + $order_vat_cal_price;
    $total = round($total, 2);
...
//        print_r($single);
        ...
        /*
            ?>
            <div class="row">
                <label class="col-md-10" id="<?php echo $single['heading'][0] ?>_<?php echo $single['sub_title'][$number]; ?>"
                       data-product_id="<?php echo $the_id; ?>" data-id="<?php echo $the_id; ?>" 
                       data-p="<?php echo $single['sub_price'][$number]; ?>" data-title="<?php echo the_title(); ?>"
                       aria-label="Add “<?php echo $single['heading'][0] ?>_<?php echo $single['sub_title'][$number]; ?>” to your cart" 
                       rel="nofollow">
                ...
                <label class="col-md-2" for="<?php echo $single['heading'][0] ?>_<?php echo $single['sub_title'][$number]; ?>">
    ...
    <div class="row">
                           ...
                           <!--href="?add-to-cart=<?php // echo $the_id;     ?>"-->
        <a id="add_extra_to_cart" class="mt-4 btn btn-info add_menu_extra_to_cart  add_menu_item_to_cart add_to_cart_button ajax_add_to_cart" 
           href="javascript:void(0)" onclick="add_ext_crt(this)"
           data-product_id="<?php echo $the_id; ?>" data-id="<?php echo $the_id; ?>">
            ADD TO MENU
        </a>
