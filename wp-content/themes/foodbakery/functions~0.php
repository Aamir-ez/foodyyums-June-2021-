...
function add_sidebar_checkout() {
    ...
    <div class=" rgt right_sidebar widget-area sidebar sticky-sidebar" style="position: relative; overflow: visible; box-sizing: border-box; min-height: 1px;">
        <?php ?>
                            ...
                            <ul>
                                ...
                                <li class="restaurant-fee-con"><span class="fee-title">Order fee</span>
                                    <span class="price">£<em class="menu-charges" id="fee" data-fee="<?php
                                        ...
                                        ?>"><?php echo get_option('_order_fee'); ?></em>  </span>                                                                                  </span>
                                </li>
...
function ez_remove_menu_item_from_cart() {
    ...
    $cartId = WC()->cart->generate_cart_id($_REQUEST['the_id']);
