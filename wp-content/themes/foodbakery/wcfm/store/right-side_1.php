                ...
                <div class="select-option dev-select-fee-option">
                    ...
                    <ul>
                        ...
                        <?php if ($restaurant_delivery_or_pickup == 'pickup' || $restaurant_delivery_or_pickup == 'delivery_and_pickup'): ?>
                            <li>
                                <input id="order-pick-up-fee" checked="checked" type="radio" value="pickup" name="order_fee_type" data-fee="<?php echo pickup_fee();
                        ;
                            ?>" value="<?php echo pickup_fee();
                                   ;
...
<?php // print_r($_SESSION) ?>
                            ...
                            <li class="restaurant-fee-con"><span class="fee-title">Order fee</span>
                                <span class="price">£<em class="menu-charges" id="fee" data-fee="<?php echo pickup_fee();
;
