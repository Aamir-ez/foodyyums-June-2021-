...
//session_start();
$store_tabs = array(
    "products" => __('<i class="icon- icon-room_service"></i> Menu', 'wc-multivendor-marketplace'),
//    "policies" => __('Policies', 'wc-multivendor-marketplace'),
    "reviews" => __('<i class="icon- icon-textsms"></i> Reviews', 'wc-multivendor-marketplace'),
//    "followers" => __('Followers', 'wc-multivendor-marketplace'),
//    "followings" => __('Followings', 'wc-multivendor-marketplace'),
//    "articles" => __('Book a Table', 'wc-multivendor-marketplace'),
    "about" => __('<i class="icon- icon-info3"></i> Info', 'wc-multivendor-marketplace'),
);
