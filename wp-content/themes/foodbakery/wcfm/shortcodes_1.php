...
add_shortcode('register_restorant_form', 'ez_register_restorant_form');
...
?>
<style>
    .tabs-container-main {padding: 25px 0;}
    .tabs-container-main .row:not(.steps) {padding: 0 30px;}
    ...
    #loading .loader {            top: 120px;            padding-top: 200px;            max-height: 410px;        }
    .thank_you{margin:50px auto;padding:50px 10px;}
    .thank_you h1 {
    ...
    <form id="ez_restorant_registration_form" class="ez_restorant_registration_form">
        <fieldset id="step_1">
            ...
            <!--                <div class="row ml-0 mr-0">
                                <div class="col-md-12">
                                    <div class="field-holder">
                                        <div class="mt-2 mb-1"><label for="loc_address">Complete address</label></div>
            ...
            <div class="row ml-0 mr-0">
                ...
                <!--                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="field-holder search-location-map input-button-loader">
                                            <input type="button" class="acc-submit cs-section-update cs-color csborder-color gllpSearchButton" id="foodbakery_map_search_btn" name="foodbakery_map_search_btn" value="Search Location" placeholder="">
                                            <div class="foodbakery-button-loader" style="display: none;">
                                                <div class="spinner">
            ...
            <div class="row ml-0 mr-0">
                <div class="col-md-12">
                    <div class="field-holder">
                        ...
                        <select name="restaurant_cuisines" class="form-control required" id="restaurant_cuisines">
...
array(
'ID' => $user_id,
 'nickname' => $_REQUEST['restorant_name']
)
);
...
update_user_meta($user_id, 'user_nicename', $_REQUEST['restorant_name']);
...
update_user_meta($user_id, '_wcfm_store_location', $_REQUEST['restaurant_address']);
...
update_user_meta($user_id, '_wcfm_billing_first_name', $_REQUEST['billing_firtname']);
update_user_meta($user_id, 'billing_first_name', $_REQUEST['billing_firtname']);
...
//    print_r($_REQUEST);
//    die();
if (email_exists($_REQUEST['Email']) != 0) {
echo true;
exit();
} else {
echo false;
...
?><style>
    form{
        background-color:#c33332 !important;padding: 30px 20px;
    }
    input[type="text"] {
...
<form action="foodyyum-listings" method="GET" id="">
    <div class="row">
        <div class="col-md-5"><input type="text" class="form-control" id="search_restorant" name="search_restorant" placeholder="Resturant name"/></div>
        <div class="col-md-5"><input type="text" class="form-control" id="search_radius" name="search_radius" placeholder="All locations"/></div>
        <div class="col-md-2"><button type="submit" name="submit" id="submit">Search</button></div>
    </div>
    &nbsp;
</form>
<?php
/* ?> <script type='text/javascript' src='https://maps.googleapis.com/maps/api/js?key=AIzaSyCAHpcM94Q5WRRfdwMzFSjH6ti14DXw9Og&#038;libraries=places%2Cdrawing&#038;ver=5.6.2' id='google-autocomplete-js'></script>
  <link rel='stylesheet' id='bootstrap_slider-css'  href='https://foodyyums.com/wp-content/plugins/wp-foodbakery/assets/frontend/css/bootstrap-slider.css?ver=5.6.2' type='text/css' media='all' />
  <script type='text/javascript' src='https://foodyyums.com/wp-content/plugins/wp-foodbakery/assets/frontend/scripts/bootstrap-slider.js?ver=5.6.2' id='bootstrap-slider-js'></script>
  <div class="main-search fancy bg-holder">
  <form name="foodbakery-restaurant-form" id="frm_restaurant_arg642126" action="https://foodyyums.com/listings/">
  <div class="row">
  <div class="col-lg-6 col-md-6 col-sm-5 col-xs-12">
  <div class="field-holder">
  <input type="text" placeholder="Resturant name" name="search_title" value="">
  </div>
  </div>
  <div class="col-lg-4 col-md-4 col-sm-5 col-xs-12">
  <div class="field-holder">
  <ul>
  <li class="select-location"><div class="foodbakery-locations-fields-group foodbakery-focus-out"><span class="foodbakery-search-location-icon" data-id="642126"><i class="icon-location"></i></span><span class="foodbakery-input-cross foodbakery-input-cross642126" data-id="642126" style="display:none;"><i class="icon-cross"></i></span><span id="foodbakery-radius-location642126" class="foodbakery-radius-location foodbakery-radius-location642126" data-id="642126"><i class="icon-target5"></i></span><input type="text" class="location-field-text foodbakery-locations-field-geo642126 filter" data-id="642126" value="" id="foodbakery-locations-field" name="location" placeholder="All Locations" autocomplete="off"><input type="hidden" class="foodbakery-locations-position642126" value="filter" id="foodbakery-locations-position642126" name="foodbakery_locations_position"><input type="hidden" name="search_type" class="search_type" value="autocomplete"><div class="cs_location_autocomplete city-autocomplete" style="width: 353.333px; left: 801.133px; top: 925.5px; display: none;"></div></div><div class="select-location foodbakery-radius-range642126" style="display:none"><div class="select-popup popup-open" id="popup642126"> <a href="javascript:;" id="close642126" class="location-close-popup location-close-popup642126"><i class="icon-times"></i></a><input type="hidden" id="range-hidden-foodbakery-radius642126" class="foodbakery-radius" data-id="642126" name="foodbakery_radius" value="10"><p>Show with in</p>
  <div class="slider slider-horizontal" id=""><div class="slider-track"><div class="slider-track-low" style="left: 0px; width: 0%;"></div><div class="slider-selection" style="left: 0%; width: 2%;"></div><div class="slider-track-high" style="right: 0px; width: 98%;"></div><div class="slider-handle min-slider-handle round" role="slider" aria-valuemin="0" aria-valuemax="500" style="left: 2%;" aria-valuenow="10" tabindex="0"></div><div class="slider-handle max-slider-handle round hide" role="slider" aria-valuemin="0" aria-valuemax="500" style="left: 0%;" aria-valuenow="0" tabindex="0"></div></div><div class="tooltip tooltip-main top" role="presentation" style="left: 2%; margin-left: 0px;"><div class="tooltip-arrow"></div><div class="tooltip-inner">10</div></div><div class="tooltip tooltip-min top" role="presentation"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div><div class="tooltip tooltip-max top" role="presentation"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div></div><input id="ex16b642126" type="text" style="display: none;" data-value="10" value="10">
  <span id="ex16b642126CurrentSliderValLabel">Miles: <span id="ex16b642126SliderVal">10</span></span><br><p class="my-location">of <i class="cs-color icon-location-arrow"></i><a id="foodbakery-geo-location642126" class="cs-color foodbakery-geo-location642126" href="javascript:void(0)">My location</a></p>
  </div></div><script>
  jQuery(document).ready(function () {
  var elem = jQuery("#ex16b642126");
  if (elem.length != "") {
  elem.slider({
  step: 1,
  min: 0,
  ...
  var val = elem.val();
  jQuery("#range-hidden-foodbakery-radius642126").val(val);
  jQuery("#ex16b642126SliderVal").html(val);


  });
  elem.on("slide", function (e, ui) {
  jQuery("#ex16b642126SliderVal").html(elem.val());
  });

  }
  jQuery(".location-close-popup642126").click(function () {
  jQuery(".foodbakery-radius-range642126").hide();
  });
  });
  </script><script>
  jQuery(document).ready(function () {
  jQuery(".chosen-select-location").chosen();
  chosen_ajaxify("filter-location-box642126", "https://foodyyums.com/wp-admin/admin-ajax.php", "dropdown_options_for_search_location_data");
  });
  </script><script>
  jQuery(document).ready(function () {
  jQuery(".chosen-select-location").chosen();
...
jQuery(document).on("keyup", ".foodbakery-locations-field642126", function () {
if (jQuery(this).hasClass("filter")) {
return;
}
var this_value = jQuery(this).val();
var this_position = jQuery("#foodbakery-locations-position642126").val();
...
jQuery(".foodbakery-all-locations642126").html(response);
}
});
} else {
jQuery.ajax({
...
jQuery(document).on("focus", ".foodbakery-locations-field642126", function () {
jQuery("#range-hidden-foodbakery-radius").val(0);
jQuery(".foodbakery-radius-range").hide();
jQuery(this).keyup();
});

jQuery(document).on("click", ".foodbakery-all-locations642126 li", function () {
var this_value = jQuery(this).text();
jQuery(".foodbakery-locations-field642126").val(this_value);
var this_position = jQuery("#foodbakery-locations-position642126").val();
if (this_position != "header") {
var data_counter = jQuery(".foodbakery-locations-field642126").data("id");
jQuery("#range-hidden-foodbakery-radius642126").val(0);
jQuery(".foodbakery-radius-range").hide();
foodbakery_restaurant_content(data_counter);
}
});
jQuery(document).on("keypress", ".foodbakery-locations-fields-group input[name='location']", function (e) {
var key = e.keyCode || e.which;
if (key == 13) {
jQuery(".location-field-text").val(jQuery(this).val());
jQuery("#range-hidden-foodbakery-radius642126").val(0);
jQuery(".location-field-text").parents("form").submit();
}
});
...
jQuery(document).on("click", ".foodbakery-input-cross642126", function () {
...
jQuery(document).on("change", ".location-field-text", function () {
...
jQuery(document).on("click", ".foodbakery-geo-location642126", function () {
var gmap_api_key = "AIzaSyCAHpcM94Q5WRRfdwMzFSjH6ti14DXw9Og";
var radiu_val = jQuery("#range-hidden-foodbakery-radius642126").val();
var _this_f = jQuery(this);
var data_id = jQuery(this).data("id");
jQuery(".foodbakery-locations-field-geo" + data_id).val("");
jQuery("#range-hidden-foodbakery-radius642126").val(radiu_val);
...
jQuery(".foodbakery-locations-field642126, .foodbakery-locations-field-geo642126").val(response.results[0].formatted_address);

jQuery(".foodbakery-input-cross642126").show();
...
jQuery(".foodbakery-radius-location642126").click(function () {
var data_id = jQuery(this).data("id");
jQuery(".foodbakery-radius-range" + data_id).toggle();
});
});
