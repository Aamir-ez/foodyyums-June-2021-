                    ...
                    <div class="detail-map-restaurant">
                        <div id="Restaurant-content">
                            <form id="ez_search_restaurants">
                                ...
                                <input type="hidden" name="zip_code" value="<?php echo isset($_GET['search_zipcode']) ? $_GET['search_zipcode'] : "" ?>"/>
...
function ez_list_restaurants() {
    ...
    @$restaurant_zipcode = $_REQUEST['zip_code'];
    ...
    if (isset($restaurant_zipcode) && $restaurant_zipcode != "") {
//        $condition .= " AND u1._wcfm_zip LIKE '%" . $_GET['restaurant_zipcode'] . "%'";
        $condition .= " AND m7.meta_value =" . $restaurant_zipcode;
    }
...
//LEFT JOIN {$wpdb->prefix}usermeta m7 ON (m7.user_id = u1.id AND m7.meta_key = '_wcfm_zip')";
//INNER JOIN {$wpdb->prefix}usermeta m7 ON (m7.user_id = u1.id AND m7.meta_key = '_wcfm_zip')
