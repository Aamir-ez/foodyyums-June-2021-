...
//        echo '<pre>';
//        print_r($item['sub_title']);
//        echo count($item['sub_title']);
//        print_r($single);
//        echo '</pre>';
            ?>
            <div class="row">
...
//        endforeach;
        ...
        <div class="row">
                                        ...
                                        <div class="col-md-6">                                                                                                                       <!--href="?add-to-cart=<?php // echo $the_id;                         ?>"-->
...
function add_items_to_woo_cart($id = null) {
//    print_r($_REQUEST);
    global $woocommerce;
...
//            echo 'single extra :' . $single_extra;
    ...
    echo json_encode(array('Status' => true, 'parent_id' => $parent_id, 'sub_ids' => $sub_ids));
    exit();
}
